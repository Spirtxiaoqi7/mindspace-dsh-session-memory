	...
	return class SessionMemoryService extends _classSuper {
		...
		registerTools() {
			...
			this.ctx.tools.register(defineTool({
				...
				description: "Read both memory faces, active mode, neutral bridge, and activity when existing details or ids are needed. Ordinary atomic writes do not require this first.",
				parameters: {},
				output: {
					schema: { type: "json" },
					render: (_args, value) => [{
...
//#endregion
export { renderSessionMemory as a, emptyModeMemory as c, foldSessionMemory as d, migrateLegacyDocument as f, renderBridge as i, emptySessionMemory as l, sessionMemoryView as m, SessionMemoryService as n, renderSessionMemoryContext as o, migrateV4Document as p, renderAssistantRequirements as r, applySessionMemoryEvent as s, MEMORY_TOOL_GUIDANCE as t, emptySessionMemoryFoldState as u };
