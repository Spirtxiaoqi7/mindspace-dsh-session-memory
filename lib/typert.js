...
const ContentBlockRemoteCodec$schema2 = z.union([
	z.object({
		"type": z.literal("text"),
		"text": z.string()
	}),
...
const _deepseek_ai_dsh_session_memory_governance_sessionMemory_replace_result$schema = z.union([z.object({
	...
	"error": z.object({
		"code": z.union([
			z.literal("stale-revision"),
			z.literal("invalid-document"),
			z.literal("text-too-large")
		]).readonly(),
...
const TYPERT = {
	...
	model: {
		"services": [{
			"description": "Session-memory service: Remote read/edit, replay projection, prompt contribution, and extraction.",
			"summary": "Session-memory service: Remote read/edit, replay projection, prompt contribution, and extraction.",
			"tags": [],
			"jsDoc": "/** Session-memory service: Remote read/edit, replay projection, prompt contribution, and extraction. */",
			"key": "sessionMemory",
			...
			"members": [{
				...
				"summary": "Read one live session's current memory view.",
				"jsDoc": "/** Read one live session's current memory view. */"
			}, {
				"kind": "method",
				"name": "replace",
				...
				"summary": "Replace editable fields if the caller observed the current revision.",
				"jsDoc": "/** Replace editable fields if the caller observed the current revision. */"
			}],
			"types": [
				{
					"name": "Agent",
				...
				},
				{
					...
					"declaration": "export interface SessionMemoryChangeEventData {\n    readonly version: 1;\n    readonly operation: 'replace';\n    readonly document: SessionMemoryDocument;\n}"
				},
				{
				...
				{
					"name": "SessionMemorySummary",
					"declaration": "export interface SessionMemorySummary {\n    readonly content: readonly ContentBlock[];\n    readonly text: string;\n    readonly source: 'compaction' | 'user';\n    readonly sourceSeq: number;\n}"
				},
				{
