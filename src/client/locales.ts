export const zh = {
  ...
  relationship: '关系与窗口使命', relationshipHint: '填写并保存后，它会替换模型本会话最前面的 Harness 默认身份；没有填写时，仍使用默认身份。', identityPreview: '模型看到的本会话首条身份提示', roleplayPreset: '扮演预设', roleplayHint: '预设仅对当前选中会话生效；关闭后保留内容但不注入模型。它是后续风格层，不覆盖窗口使命。',
...
export const en: typeof zh = {
  ...
  relationship: 'Relationship and window purpose', relationshipHint: 'After saving, this replaces the leading Harness identity for this session. Without it, the default identity remains.', identityPreview: 'First session identity prompt seen by the model', roleplayPreset: 'Roleplay preset', roleplayHint: 'This preset applies only to the selected session. Disabling it keeps the text but removes it from the model prompt. It is a later style layer and does not override the session mission.',
